...
// 1. Xác định đường dẫn gốc (để xử lý việc file nằm trong thư mục pages/ hay root)
...
// 5. Hàm khởi tạo (Render)
export function initLayout() {
    document.body.insertAdjacentHTML('afterbegin', navHTML); // Thêm Menu lên đầu
    document.body.insertAdjacentHTML('beforeend', footerHTML); // Thêm Footer xuống cuối
    document.body.insertAdjacentHTML('beforeend', chatHTML); // Thêm Chat widget
